...
echo "  ✓ UART/Serial enabled"
echo "  ✓ Logging to logs/app.log"
echo ""
echo "🔄 Next steps:"
echo "  1. Reboot your Raspberry Pi:"
echo "     sudo reboot"
echo ""
echo "  2. After reboot, your app will start automatically!"
echo ""
echo "📊 Useful commands:"
echo "  • View logs:        tail -f /home/pi/conzero-jet-project/logs/app.log"
echo "  • Disable autostart: rm ~/.config/autostart/conzero-jet.desktop"
echo "  • Re-enable:        ./setup_production.sh"
echo "  • Test manually:    ./start_conzero.sh"
echo ""
echo "========================================="